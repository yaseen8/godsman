        ...
        <View style={{ height: "100%"}}>
            ...
            <View style={styles.bgTop}>
                <ImageBackground style={styles.bgPattern} source={BgPattern}>
                    <View style={styles.positionTitle}>
                        <Text style={styles.titleText}>Talk directly with our representative</Text>
                    </View>
                </ImageBackground>
            </View>
            ...
            <View style={styles.completeWrap}>
                <View style={styles.completeInner}>
                    ...
                    <Text style={styles.descText}>Call will be made to our call center using your newtork. Charges apply.</Text>
                </View>
            </View>
        </View>
    </View>
